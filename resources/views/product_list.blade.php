...
@section('content')
    ...
    <div class="right_col" role="main">
                            ...
                            <div class="col-12 p-3">
                                <div class="row">
                                    ...
                                    <div class="col-3 p-0 pr-1">
                                        ...
                                        <input type="text" name="editBrand" class="form-control" list="editBrandList"
                                            id="editBrand">
                                    ...
                                    <div class="col-12 p-0">
                                        ...
                                        <textarea name="editProductIntro" id="editProductIntro" cols="30" rows="10"
                                ...
                                <div class="" id="editProductTypeBlock">
                                    <div class="row mt-2">
                                        <select name="editProductType1" id="editProductType1"
                                            class="form-control col-12 m-0 editProductType text-center" disabled>
                                    ...
                                    <div class="row mt-2">
                                        <select name="editProductType2" id="editProductType2"
                                            class="form-control col-12 m-0 editProductType" disabled>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <input class="" id="productPhotoUpload" type="file" name="file[]"
        ...
        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true" id="deleteModal">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header row">
                        <h3 class="modal-title col-12 text-center font-weight-bold" id="exampleModalCenterTitle">確定刪除此項商品?
                        </h3>
                        <p class="modal-title col-12 text-center text-danger">商品：<span id="deleteAlert"
                ...
                <div class="col-md-12 col-sm-12  ">
                    <div class="x_panel">
                        <div class="x_title d-flex justify-content-between">
                            <h2>商品列表</h2>
                            <a class="btn btn-dark text-nowrap m-0 border-0 text-white"
                                style="border-radius:5px; font-size:14px" href="product_creat.php" type="submit"><i
                                    class="fas fa-plus mr-2"></i>新增商品</a>
                        </div>
                        <div class="x_content d-flex flex-column">
                            ...
                            <div class="d-flex py-2 align-items-center">
                                ...
                                <select id="brandFilter"
                                    class="category-filter form-control form-control-sm text-white ml-1"
                                    style="width: 200px; background-color:#2A3F54;border:none;border-radius:5px;">
                                    <option value="0">所有品牌</option>
                                </select>
                                <select id="categoryFilter" class="form-control form-control-sm text-white ml-1"
                                    style="width: 120px; background-color:#2A3F54;border:none;border-radius:5px;">
                                    <option value="0">所有分類</option>
                                </select>
                                <a id="filterSearch"
                                    class="filter-search btn btn-dark p-0 m-0 d-flex align-items-center justify-content-center ml-1 text-white"><i
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                    <thead>
                                        <tr class="headings">
                                            ...
                                            <th class="px-2 py-3 text-center" data-sort="upload_time" id="uploadTime">上架時間
                                            </th>
                                            <th class="px-2 py-3 text-center" data-sort="upload_time" id="updateTime">
                                                最後更新時間<i class="fas fa-sort"></i></th>
                                    ...
                                    <tbody id="productTbody">
                                        @foreach ($product as $item)
                                            <tr class="even pointer p-0">
                                                <td class="align-middle text-center p-2">{{$item['id']}}</td>
                                                <td class="align-middle p-2" style="max-width: 200px;">{{$item['name']}}</td>
                                                <td class="align-middle  text-center p-2"></td>
                                                <td class="align-middle px-2 p-1 text-truncate" style="max-width: 300px;">
                                                </td>
                                                <td class="align-middle text-right p-2"></td>
                                                <td class="align-middle text-right p-2"></td>
                                                <td class="align-middle text-center p-2"></td>
                                                <td class="align-middle text-center p-2"></td>
                                                <td class="align-middle text-center p-2"></td>
                            ...
                            <div id="pageBtnGroup" class="btn-group mr-2 align-self-center" role="group"
